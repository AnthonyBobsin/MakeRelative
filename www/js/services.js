...
var geocode = ['$q', '$resource', '$http', 'GEOCODE_KEY', 
  function($q, $resource, $http, GEOCODE_KEY) {
  var url = 'https://maps.googleapis.com/maps/api/geocode/json?key=' + GEOCODE_KEY + '&address=';
  ...
  return {
    ...
    getLocation: function(userLocation) {
      return $http.get(url + userLocation + '?callback=JSON_CALLBACK');
    }
  }
}];
